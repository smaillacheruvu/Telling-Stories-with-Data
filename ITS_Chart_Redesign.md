...
I also wanted to <b>improve the chart's truthfulness by removing the "Other" category,</b> as the sub-questions to assess for "Other" technologies weren't consistent across survey years. That is, the 2020 survey instrument asked a few specific questions on "Other" technologies, whereas the 2013 and 2016 survey instruments simply had an open-ended "Other" technology write-in question. The extra prompts in the 2020 instrument might bolster response rates, inflating this category compared to prior-year surveys. In addition to improving the chart's accuracy, removing the "Other" category also led to a visually cleaner graph.
...
-[Ison Tech](https://www.ison-tech.com/index.php/application/its)<br>
...
<br>
#### HTML References:
-[Stack - Lists](https://stackoverflow.com/questions/18413660/html-how-to-insert-links-into-ordered-unordered-lists)<br>
-[W3School - Images](https://www.w3schools.com/howto/howto_css_images_side_by_side.asp)<br>
